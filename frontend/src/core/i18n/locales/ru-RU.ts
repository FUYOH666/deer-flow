...
export const ruRU: Translations = {
  ...
  welcome: {
    ...
    createYourOwnSkillDescription:
      "Создайте свой навык для расширения возможностей ассистента. С пользовательскими навыками можно искать в интернете, анализировать данные и создавать презентации, веб-страницы и многое другое.",
  },
