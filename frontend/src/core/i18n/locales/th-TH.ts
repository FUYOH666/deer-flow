...
export const thTH: Translations = {
  ...
  welcome: {
    greeting: "สวัสดี!",
    description: "ส่งข้อความเพื่อเริ่มต้น",

    createYourOwnSkill: "สร้างสกิลของคุณเอง",
    createYourOwnSkillDescription:
      "สร้างสกิลของคุณเองเพื่อขยายความสามารถของผู้ช่วย ด้วยสกิลที่กำหนดเอง สามารถช่วยคุณค้นหาบนเว็บ วิเคราะห์ข้อมูล และสร้างงานอย่างสไลด์ หน้าเว็บ และอื่นๆ ได้เกือบทุกอย่าง",
  },
